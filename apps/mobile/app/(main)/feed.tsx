...
import { Container, Button, Text, Card } from '@bondfires/ui'
  ...
  return (
    ...
    >
      ...
      <YStack alignItems="center" gap="$2">
        <Text fontSize="$5" fontWeight="600">No bondfires yet</Text>
...
export default function FeedScreen() {
  ...
  const handleBondfirePress = useCallback((bondfireId: string) => {
  ...
  if (bondfires === undefined) {
    return (
      <Container centered>
        ...
        <Text marginTop="$4" color="$gray11">Loading feed...</Text>
      </Container>
    )
  }
