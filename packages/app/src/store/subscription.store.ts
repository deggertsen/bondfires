...
> = {
  plus: {
    ...
    displayName: 'Plus',
    description: 'Create bondfires in any camp and your personal camp.',
    features: [
      { label: 'Create bondfires in any camp you join' },
      { label: 'Your own personal camp' },
      { label: '15-minute recordings' },
      { label: '1-month video storage in personal camp' },
    ],
  },
  premium: {
    ...
    displayName: 'Premium',
    description: 'Keep personal camp videos without the Plus storage limit.',
    features: [
      { label: 'Everything in Plus' },
      { label: 'Unlimited video storage in personal camp' },
